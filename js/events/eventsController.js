...
eventsList.push(
    ...
    new EventsSideBlock({
        ...
        description: "Декарь 2020 года. <br> Геворкян Марат подготовил презентацию и провел мастер-класс по C#. <br> По окончанию мастер-класса мы создали калькуляторы. Презентацию с мастер-класса можно найти по ссылке: https://collegemirbis-my.sharepoint.com/:f:/g/personal/kolonings20_st_ithub_ru/Ek9_k5hUipBPsN6bs3-i6B8B0L2SMJeYB5UHHC4MlT8c5g <br>", 
        daddy: sideBlock,
        year: 2020,
        semester: '1-ый семестр'
    }),
    ...
    new EventsSideBlock({
        ...
        description: "Декарь 2020 года. <br> Колонин Глеб подготовил презентацию и провел мастер-класс по \"Основам git и GitHub\". <br> В конце дал рекомендации и ресурсы для дальнейшего изучения. Презентацию с мастер-класса можно найти по ссылке: https://collegemirbis-my.sharepoint.com/:f:/g/personal/kolonings20_st_ithub_ru/Ek9_k5hUipBPsN6bs3-i6B8B0L2SMJeYB5UHHC4MlT8c5g <br>", 
        daddy: sideBlock,
        year: 2020,
        semester: '1-ый семестр'
    }),
    ...
    new EventsSideBlock({
        ...
        description: "Март 2021 года. <br> Молодоря Никита - провел мастер-класс по программированию на Swift. <br> В течении мастер-класса велась разработка мобильного приложения, <br> которое следило за котировками валют. Презентацию с мастер-класса можно найти по ссылке: https://collegemirbis-my.sharepoint.com/:f:/g/personal/kolonings20_st_ithub_ru/Ek9_k5hUipBPsN6bs3-i6B8B0L2SMJeYB5UHHC4MlT8c5g <br>", 
        daddy: sideBlock,
        year: 2021,
        semester: '2-ой семестр'
    }),
    ...
    new EventsSideBlock({
        ...
        background: "url(images/gallery_of_events/2_Semestr/7_Nikolay_merge_sort.jpeg)", 
        description: "12 Апреля 2021 года. <br> Квашин Николай провел выступление, на котором рассказал об эффективной сортировке merge-sort. Был разобран код, который реализует данную сортировку, а также её преимущества. <br> Презентацию с выступления можно найти по ссылке: https://collegemirbis-my.sharepoint.com/:f:/g/personal/kolonings20_st_ithub_ru/Ek9_k5hUipBPsN6bs3-i6B8B0L2SMJeYB5UHHC4MlT8c5g <br>",
        daddy: sideBlock,
        year: 2021,
        semester: '2-ой семестр'
    }),
    ...
    new EventsSideBlock({
        ...
        background: "url(images/gallery_of_events/2_Semestr/8_Gleb_Investing.jpg)",
        description: "22 Апреля 2021 года. <br> Колонин Глеб выступил по теме Основы финансовой грамотности и Инвестирования. <br> Он ответил на вопросы аудитории, поделился своим опытом инвестирования и дал ресурсы дя дальнейшего изучения темы. <br> Презентацию с выступления можно найти по ссылке: https://collegemirbis-my.sharepoint.com/:f:/g/personal/kolonings20_st_ithub_ru/Ek9_k5hUipBPsN6bs3-i6B8B0L2SMJeYB5UHHC4MlT8c5g <br>",
        daddy: sideBlock,
        year: 2021,
        semester: '2-ой семестр'
    })
